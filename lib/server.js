...
router.set('/api/targets', { GET: api.getAllTargets, POST: api.createTarget })
router.set('/api/targets/:id', { GET: api.getTarget, POST: api.updateTarget })
router.set('/route', { POST: api.createVisitorRequest })
